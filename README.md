# Cellular Automata Sand Falling Simulation

the goal of this project is to practice many low level programming languages.
Ai usage can be found [here](#ai-usage)
## Odin build
### Progression
>* finished powder material code, but polishing needed, especially constants 
>* player input capturing is working well
>* implemented chunk-based update, and it's working
### Current Goal
>* add liquid and gass
